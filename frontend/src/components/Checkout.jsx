...
import ProductImg from '../assets/images/seven.jpg'
            ...
            <div className="row">
                <div className="col-md-7">
                    ...
                    <form action="">
                        <div className="row pt-3">
                            ...
                            <div className="mb-3">
                                <textarea name="" id="" rows={3} className='form-control'  placeholder='Address'></textarea>
                            </div>
                            ...
                            <div className="col-md-6">
                                <div className="mb-3">
                                    <input type="text" name="" id="" className='form-control'  placeholder='Mobile'/>
                                </div>
                            </div>
                ...
                <div className="col-md-5">
                    ...
                    <div className='pt-2'>
                        ...
                        <input type="radio" name="" id="" 
                        onClick={handlePaymentMethod}
                        className='ms-3' checked={paymentMethod == 'cod'} value={'cod'}/>
